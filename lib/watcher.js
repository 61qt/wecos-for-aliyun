...
function runFileTask(filepath, event, stat) {
	...
	if (pathLib.extname(filepath) && _.includes(globalConfig['uploadFileSuffix'], pathLib.extname(filepath))) {
...
function watchFile(option) {
	...
	if (globalConfig.watch) {
		console.log('/***** 【微信 COS 瘦身工具】 start watching *****/');
